 ...
 */
 ...
 export const imageProxy = () => 'https://images.hive.blog/';
  ...
  * @param {string} url
  * @param {string|boolean} dimensions - optional -  if provided. url is proxied && global var is avail. resp will be"
 ...
 export const proxifyImageUrl = (url, dimensions = false) => {
     ...
     if (dimensions) {
         ...
         if ((NATURAL_SIZE !== dims && CAPPED_SIZE !== dims) || !rProxyDomain.test(respUrl)) {
             return 'https://images.hive.blog/' + dims + respUrl;
         }
     }
     return respUrl;
 };
